...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "7407891566:AAETTBrfgRDvkUxj_NoZzIRl8dPf-GMbh10"  # API key obtained from BotFather
    OWNER_ID = "414590268"  # If you dont know, run the bot and do /id in your private chat with the bot
